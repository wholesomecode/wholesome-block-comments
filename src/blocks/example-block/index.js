 ...
 */
export default registerBlockType( 'wholesome-publishing/example-block', {

	// Set the title.
	title: __( 'Example', 'wholesome-publishing' ),
	 ...
	 */
	styles: [
		{ name: 'image-left', label: __( 'Image Left', 'wholesome-publishing' ), isDefault: true },
		{ name: 'image-right', label: __( 'Image Right', 'wholesome-publishing' ) },
	],
