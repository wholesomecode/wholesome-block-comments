			...
			<MediaUploadCheck>
				<InspectorControlsOriginal>
					<PanelBody
						...
						initialOpen={ false }
						title={ __( 'Edit Image', 'wholesome-publishing' ) }
					>
						<div className="editor-post-featured-image">
									...
									<Fragment>
										{ imageURL ? (
											...
											<Button className="editor-post-featured-image__toggle" onClick={ open }>
												{ __( 'Set block image', 'wholesome-publishing' ) }
											</Button>
										) }
									</Fragment>
								) }
							...
							{ imageURL && (
								<Fragment>
									<MediaUpload
										title={ __( 'Replace image', 'wholesome-publishing' ) }
										onSelect={ onChangeImageID }
										type="image"
										modalClass="editor-post-featured-image__media-modal"
										render={ ( { open } ) => (
											<Button onClick={ open } isSecondary isLarge>
												{ __( 'Replace image', 'wholesome-publishing' ) }
											</Button>
										) }
									/>
									<Button
										isLink
										isDestructive
										label={ __( 'Remove block image', 'wholesome-publishing' ) }
									...
									>
										{ __( 'Remove Image', 'wholesome-publishing' ) }
									</Button>
								</Fragment>
							) }
						</div>
