# Wholesome Block Comments (Formally Wholseome Publishing)
...
*Please Note:* This plugin is now outdated, as it was written for an older version of Gutenberg. 
Because of this, it may no longer work as intended, but the code should still be readable.

You will be pleased to know that I am making a new version this plugin, and I will be releasing 
it in the near future, with the extra added addition of inline block comments. 

Feel free to have a look around, it might do something, but at the moment it won't do it well.

I hope that you find it usful, either as a standalone plugin for your WordPress website, or as parts for something 
amazing that you are working on.

If you wish to make changes to the plugin just `cd` into this directory and 
run `npm install && npm start`. That will compile all of the SCSS and JavaScript files.

You can find corrosponding tutorials that explore these files further
