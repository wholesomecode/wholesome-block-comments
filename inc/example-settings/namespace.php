...
function add_settings_page() : void {
	$page_hook_suffix = add_options_page(
		__( 'Wholesome Publishing Settings', 'wholesome-publishing' ),
		__( 'Wholesome Publishing Settings', 'wholesome-publishing' ),
		'manage_options',
		SETTING_SLUG,
...
function render_html() : void {
	?>
	<div id="wholesome-publishing-settings"></div>
	<?php
}
...
function block_settings( $settings ) : array {
	$example_dropdown_options = [
		[
			'label' => esc_html__( 'Example One', 'wholesome-publishing' ),
			'value' => 'example-one',
		],
		[
			'label' => esc_html__( 'Example Two', 'wholesome-publishing' ),
			'value' => 'example-two',
		],
	];
...
function settings_link( $links ) : array {
	array_unshift( $links, '<a href="options-general.php?page=' . esc_attr( SETTING_SLUG ) . '">' . esc_html__( 'Settings', 'wholesome-publishing' ) . '</a>' );
